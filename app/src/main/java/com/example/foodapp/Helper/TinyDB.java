...
public class TinyDB {
    ...
    public ArrayList<FoodModel> getListObject(String key) {
        ...
        ArrayList<FoodModel> playerList = new ArrayList<FoodModel>();

        for (String jObjString : objStrings) {
            FoodModel player = gson.fromJson(jObjString, FoodModel.class);
    ...
    public void putListObject(String key, ArrayList<FoodModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
